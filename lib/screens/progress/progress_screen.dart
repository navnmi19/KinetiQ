    ...
    return ValueListenableBuilder<ThemeMode>(
      ...
      builder: (context, mode, _) {
        ...
        return Scaffold(
          ...
          bottomNavigationBar:
              _ProgressBottomNav(colors: colors),
        );
      },
    );
  }
...
String get _progressPunchline {
  ...
  return _progressPunchlines[
      dayOfYear % _progressPunchlines.length];
}
...
class _MuscleMapCard extends StatefulWidget {
  ...
  @override
  State<_MuscleMapCard> createState() =>
      _MuscleMapCardState();
}

class _MuscleMapCardState
    extends State<_MuscleMapCard> {
  MuscleMapView _view =
      MuscleMapView.front;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // ==========================================================
          //
          // FittedBox keeps the entire mannequin visible while
          // maintaining its proportions. It is centered both
          // horizontally and vertically inside the 220px area.
          //
          // ==========================================================
...
class _FrequencyHeatmap
    extends StatelessWidget {
  final _ProgressColors colors;

  const _FrequencyHeatmap({
    required this.colors,
  });
